...
export const Sidebar = ({children, isOpen,onclickClose}) => {
  return (
    <>
    <div className={`p-5 w-full h-full bg-white fixed top-0 z-50 right-0 ${isOpen ? "translate-x-0" : "translate-x-full"} transition transform duration-300 md:w-[50%] lg:w-[35%] shadow-lg`}>
